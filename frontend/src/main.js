...
import { faCheckDouble, faSitemap } from '@fortawesome/free-solid-svg-icons'
library.add( faFaceSmile, faFaceMeh, faFaceFrown, faFaceMehBlank, faCheckDouble, faSitemap );
